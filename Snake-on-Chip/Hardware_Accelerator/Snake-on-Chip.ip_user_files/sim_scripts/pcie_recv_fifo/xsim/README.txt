...
#
# Generated by export_simulation on Wed Jul 18 20:00:58 +0300 2018
#
################################################################################
...
switch to the './pcie_recv_fifo.sh' script.

./pcie_recv_fifo.sh -reset_run
...
./pcie_recv_fifo.sh -noclean_files

For more information on the script, please type './pcie_recv_fifo.sh -help'.
