...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie_recv_fifo.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto c8de24a6f19148128a87cb40682a2a02 -m64 -L fifo_generator_v13_0_1 -L xil_defaultlib -L secureip --snapshot pcie_recv_fifo xil_defaultlib.pcie_recv_fifo -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcie_recv_fifo -key {Behavioral:sim_1:Functional:pcie_recv_fifo} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
