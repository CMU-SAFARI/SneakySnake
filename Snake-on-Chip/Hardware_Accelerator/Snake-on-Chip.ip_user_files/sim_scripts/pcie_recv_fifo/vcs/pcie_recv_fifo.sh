...
reset_run()
{
  files_to_remove=(ucli.key pcie_recv_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc pcie_recv_fifo_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.pcie_recv_fifo -o pcie_recv_fifo_simv
}
...
simulate()
{
  ...
  ./pcie_recv_fifo_simv $opts -do simulate.do
}
# Script usage
usage()
{
