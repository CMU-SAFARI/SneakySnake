...
#
# Generated by export_simulation on Wed Jul 18 20:00:45 +0300 2018
#
################################################################################
...
switch to the './shd_fifo.sh' script.

./shd_fifo.sh -reset_run
...
./shd_fifo.sh -noclean_files

For more information on the script, please type './shd_fifo.sh -help'.
