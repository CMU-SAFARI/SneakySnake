...
#
# Generated by export_simulation on Wed Jul 18 20:00:34 +0300 2018
#
################################################################################
...
switch to the './shd_pe_fifo.sh' script.

./shd_pe_fifo.sh -reset_run
...
./shd_pe_fifo.sh -noclean_files

For more information on the script, please type './shd_pe_fifo.sh -help'.
