...
#
# Generated by Vivado on Wed Jul 18 20:01:31 +0300 2018
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./clk_gen.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../GateKeeper.srcs/sources_1/ip/clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../../GateKeeper.srcs/sources_1/ip/clk_gen/clk_gen.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.clk_gen xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.clk_gen -input simulate.do
}
# Script usage
usage()
{
