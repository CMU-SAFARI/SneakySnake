...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto c8de24a6f19148128a87cb40682a2a02 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_gen xil_defaultlib.clk_gen xil_defaultlib.glbl -log elaborate.log
}
